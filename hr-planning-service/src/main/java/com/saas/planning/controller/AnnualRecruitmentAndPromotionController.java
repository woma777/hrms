...
@RestController
@RequestMapping("/api/hr-planning/annual-recruitment-promotion/{tenantId}")
...
public class AnnualRecruitmentAndPromotionController {
    ...
    public ResponseEntity<AnnualRecruitmentAndPromotionResponse> createAnnualRecruitmentAndPromotion(
            @PathVariable("tenantId") UUID tenantId, @Valid @RequestBody AnnualRecruitmentAndPromotionRequest request) {

        permissionEvaluator.addAnnualRecruitmentAndPromotionPermission(tenantId);

        AnnualRecruitmentAndPromotionResponse createdEntity =
                annualRecruitmentAndPromotionService.createAnnualRecruitmentAndPromotion(tenantId, request);
    ...
    public ResponseEntity<List<AnnualRecruitmentAndPromotionResponse>> getAllAnnualRecruitmentAndPromotions(
        ...
        List<AnnualRecruitmentAndPromotionResponse> allEntities =
                annualRecruitmentAndPromotionService.getAllAnnualRecruitmentAndPromotions(tenantId);
    ...
    public ResponseEntity<AnnualRecruitmentAndPromotionResponse> getAnnualRecruitmentAndPromotionById(
        ...
        AnnualRecruitmentAndPromotionResponse entity =
                annualRecruitmentAndPromotionService.getAnnualRecruitmentAndPromotionById(tenantId, id);
    ...
    public ResponseEntity<AnnualRecruitmentAndPromotionResponse> updateAnnualRecruitmentAndPromotion(
        ...
        AnnualRecruitmentAndPromotionResponse updatedEntity =
                annualRecruitmentAndPromotionService.updateAnnualRecruitmentAndPromotion(tenantId, id, request);

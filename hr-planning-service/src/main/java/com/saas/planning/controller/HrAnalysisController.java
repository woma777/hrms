...
@RestController
@RequestMapping("/api/hr-planning/hr-analyses/{tenantId}")
...
public class HrAnalysisController {
    ...
    public ResponseEntity<HrAnalysisResponseDto> createHrAnalysis(
            @PathVariable("tenantId") UUID tenantId, @Valid @RequestBody HrAnalysisRequestDto hrAnalysisRequestDto) {
    ...
    @GetMapping("/all")
    public ResponseEntity<List<HrAnalysisResponseDto>> getAllHrAnalyses(@PathVariable("tenantId") UUID tenantId) {
    ...
    public ResponseEntity<HrAnalysisResponseDto> updateHrAnalysis(
        ...
        HrAnalysisResponseDto updatedHrAnalysis =
                hrAnalysisService.updateHrAnalysis(tenantId, id, hrAnalysisRequestDto);
        return ResponseEntity.ok(updatedHrAnalysis);
    }

    @DeleteMapping("/{id}/delete")
    public ResponseEntity<String> deleteHrAnalysis(@PathVariable("tenantId") UUID tenantId, @PathVariable UUID id) {

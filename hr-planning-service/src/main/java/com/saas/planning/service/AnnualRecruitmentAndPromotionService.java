...
public class AnnualRecruitmentAndPromotionService {
    ...
    public AnnualRecruitmentAndPromotionResponse createAnnualRecruitmentAndPromotion(
            UUID tenantId, AnnualRecruitmentAndPromotionRequest request) {
    ...
    public AnnualRecruitmentAndPromotionResponse getAnnualRecruitmentAndPromotionById(UUID tenantId, UUID id) {
        ...
        AnnualRecruitmentAndPromotion entity = repository
                .findById(id)
                .orElseThrow(
                        () -> new ResourceNotFoundException("AnnualRecruitmentAndPromotion not found with id " + id));
        return mapper.toDto(entity);
    }

    public AnnualRecruitmentAndPromotionResponse updateAnnualRecruitmentAndPromotion(
            UUID tenantId, UUID id, AnnualRecruitmentAndPromotionRequest request) {
        validateInputs(tenantId, request);
    ...
    private HrNeedRequest fetchHrNeedRequest(UUID hrNeedRequestId) {
        return needRequestRepository
                .findById(hrNeedRequestId)

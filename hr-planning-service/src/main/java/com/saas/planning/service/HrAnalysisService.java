...
public class HrAnalysisService {
    ...
    public HrAnalysisResponseDto createHrAnalysis(UUID tenantId, HrAnalysisRequestDto hrAnalysisRequest) {
        ...
        if (hrAnalysisRequest == null
                || hrAnalysisRequest.getBudgetYearId() == null
        ...
        JobRegistrationDto jobRegistration =
                organizationServiceClient.getJobById(hrAnalysisRequest.getJobRegistrationId(), tenantId);
    ...
    public List<HrAnalysisResponseDto> getAllHrAnalyses(UUID tenantId) {
        ...
        return hrAnalyses.stream().map(hrAnalysisMapper::mapToDto).collect(Collectors.toList());
    }
    ...
    public HrAnalysisResponseDto getHrAnalysisById(UUID tenantId, UUID id) {
        ...
        HrAnalysis hrAnalysis = hrAnalysisRepository
                .findById(id)

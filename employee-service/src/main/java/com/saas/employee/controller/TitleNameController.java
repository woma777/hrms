...
public class TitleNameController {
    ...
    public ResponseEntity<?> addTitleName(
        ...
        TitleNameResponse response = titleNameService.addTitleName(tenantId, request);
    ...
    public ResponseEntity<?> getAllTitleNames(
        ...
        List<TitleNameResponse> responses = titleNameService.getAllTitleNames(tenantId);
    ...
    public ResponseEntity<?> getTitleNameById(
        ...
        TitleNameResponse response = titleNameService.getTitleNameById(tenantId, titleId);
    ...
    public ResponseEntity<?> updateTitleName(
        ...
        TitleNameResponse response = titleNameService.updateTitleName(tenantId, titleId, request);
        return ResponseEntity.status(HttpStatus.OK).body(response);
    }
    ...
    public ResponseEntity<?> deleteTitleName(
        ...
        return ResponseEntity.status(HttpStatus.OK).body("Title name deleted successfully!");
    }
}

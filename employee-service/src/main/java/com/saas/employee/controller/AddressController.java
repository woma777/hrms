...
public class AddressController {
    ...
    public ResponseEntity<?> addAddress(
        ...
        AddressResponse address = addressService.addAddress(tenantId, employeeId, addressRequest);
    ...
    public ResponseEntity<?> getAllAddresses(
        ...
        List<AddressResponse> addresses = addressService.getAllAddresses(tenantId, employeeId);
    ...
    public ResponseEntity<?> getEmployeeAddresses(
        ...
        List<AddressResponse> addresses = addressService.getEmployeeAddresses(tenantId, employeeId);
        return ResponseEntity.ok(addresses);
    }
    ...
    public ResponseEntity<?> getAddressById(
        ...
        AddressResponse address = addressService.getAddressById(tenantId, employeeId, addressId);

...
public class LanguageNameController {
    ...
    public ResponseEntity<?> addLanguageName(
        ...
        LanguageNameResponse response = languageNameService.addLanguageName(tenantId, request);
    ...
    public ResponseEntity<?> getAllLanguageNames(
        ...
        List<LanguageNameResponse> responses = languageNameService.getAllLanguageNames(tenantId);
    ...
    public ResponseEntity<?> getLanguageNameById(
        ...
        LanguageNameResponse response = languageNameService.getLanguageNameById(tenantId, languageId);

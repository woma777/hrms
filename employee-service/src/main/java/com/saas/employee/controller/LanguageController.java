...
public class LanguageController {
    ...
    public ResponseEntity<?> getAllLanguages(
        ...
        List<LanguageResponse> languages = languageService.getAllLanguages(tenantId, employeeId);
    ...
    public ResponseEntity<?> getEmployeeLanguages(
        ...
        List<LanguageResponse> languages = languageService.getEmployeeLanguages(tenantId, employeeId);
        return ResponseEntity.ok(languages);
    }
    ...
    public ResponseEntity<?> getLanguageById(
        ...
        LanguageResponse language = languageService.getLanguageById(tenantId, employeeId, languageId);

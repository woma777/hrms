...
public class FamilyController {
    ...
    public ResponseEntity<?> addFamily(
        ...
        FamilyResponse family = familyService.addFamily(tenantId, employeeId, familyRequest);
    ...
    public ResponseEntity<?> getAllFamilies(
        ...
        List<FamilyResponse> families = familyService.getAllFamilies(tenantId, employeeId);
    ...
    public ResponseEntity<?> getEmployeeFamilies(
        ...
        List<FamilyResponse> families = familyService.getEmployeeFamilies(tenantId, employeeId);
        return ResponseEntity.ok(families);
    }
    ...
    public ResponseEntity<?> getFamilyById(
        ...
        FamilyResponse family = familyService.getFamilyById(tenantId, employeeId, familyId);

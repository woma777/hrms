...
public class SkillController {
    ...
    public ResponseEntity<?> addSkill(
        ...
        SkillResponse skill = skillService.addSkill(tenantId, employeeId, skillRequest);
    ...
    public ResponseEntity<?> getAllSkills(
        ...
        List<SkillResponse> skills = skillService.getAllSkills(tenantId, employeeId);
    ...
    public ResponseEntity<?> getEmployeeSkills(
        ...
        List<SkillResponse> skills = skillService.getEmployeeSkills(tenantId, employeeId);
        return ResponseEntity.ok(skills);
    }
    ...
    public ResponseEntity<?> getSkillById(
        ...
        SkillResponse skill = skillService.getSkillById(tenantId, employeeId, skillId);

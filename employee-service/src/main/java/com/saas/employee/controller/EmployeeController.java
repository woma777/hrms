...
public class EmployeeController {
    ...
    public ResponseEntity<?> addEmployeeHistory(
        ...
        PromoteEmployeeResponse response =
                employeeService.addEmployeeHistory(tenantId, employeeId, vacancyNumber, payGradeId);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<?> getEmployeeHistories(
        ...
        List<EmployeeHistoryResponse> responses = employeeService.getEmployeeHistories(tenantId, employeeId);

...
public class EmployeeRequest {
    ...
    @NotNull(message = "Gender cannot be null") private String gender;

    @Past(message = "Date of birth must be in the past")
    private LocalDate dateOfBirth;

    @NotNull(message = "Marital status cannot be null") private String maritalStatus;

    @NotNull(message = "Employment type cannot be null") private String employmentType;

    @NotNull(message = "Department ID cannot be null") private UUID departmentId;

    @NotNull(message = "Job ID cannot be null") private UUID jobId;

    @NotNull(message = "Pay grade ID cannot be null") private UUID payGradeId;

    @NotNull(message = "Hired date cannot be null") @PastOrPresent(message = "Hired date must be in the past or present")
    ...
    @NotNull(message = "Title name ID cannot be null") private UUID titleNameId;

    @NotNull(message = "Duty station ID cannot be null") private UUID dutyStationId;

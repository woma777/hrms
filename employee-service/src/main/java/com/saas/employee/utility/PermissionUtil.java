...
public class PermissionUtil {
    ...
    public boolean hasPermission(UUID tenantId, String resourceName) {
        ...
        if (requiredRoles == null || requiredRoles.isEmpty()) {
            throw new AccessDeniedException("Access Denied - No roles are assigned to access this resource.");
        }
    ...
    public boolean isEmployeeHimself(UUID tenantId, UUID id, String employeeId) {
        ...
        if (employeeId == null) {
            ...
            return userTenantId.equals(tenantId.toString()) && loggedInUsername.equals(employee.getEmployeeId());
        } else {
            return userTenantId.equals(tenantId.toString()) && loggedInUsername.equals(employeeId);
        }
    }

    private ResourceDto getResourceByName(UUID tenantId, String resourceName) {
    ...
    private Employee getEmployeeById(UUID tenantId, UUID id) {

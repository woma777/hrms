...
public class EmployeeService {
    ...
    public EmployeeResponse addEmployee(UUID tenantId,
        ...
        if (employeeRepository.existsByTenantIdAndEmployeeId(tenant.getId(), request.getEmployeeId())) {
    ...
    public List<EmployeeResponse> getEmployeesByDepartmentId(UUID tenantId,
        ...
        DepartmentDto department = validationUtil
                .getDepartmentById(tenant.getId(), departmentId);
    ...
    public List<EmployeeResponse> getEmployeesByEmploymentType(UUID tenantId,
        ...
        List<Employee> employees = employeeRepository.findByTenantIdAndEmploymentType(
                tenant.getId(), EmploymentType.valueOf(employmentType.toUpperCase()));
    ...
    public List<EmployeeHistoryResponse> getEmployeeHistories(UUID tenantId,
        ...
        List<EmployeeHistory> employeeHistories =
                employeeHistoryRepository.findByTenantIdAndEmployeeId(tenant.getId(), employeeId);
        return employeeHistories.stream().map(employeeMapper::mapToHistoryDto).toList();
    }
    ...
    private void addEmployeeHistory(UUID tenantId,
        ...
        List<EmployeeHistory> employeeHistories =
                employeeHistoryRepository.findByTenantIdAndEmployeeId(tenantId, employee.getId());

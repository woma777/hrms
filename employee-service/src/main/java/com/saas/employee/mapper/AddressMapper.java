...
public class AddressMapper {
    ...
    public Address mapToEntity(TenantDto tenant, Employee employee, AddressRequest request) {
    ...
    public Address updateAddress(TenantDto tenant, Address address, AddressRequest request) {

...
public class LanguageNameMapper {
    ...
    public LanguageName mapToEntity(TenantDto tenant, LanguageNameRequest request) {
    ...
    public LanguageName updateEntity(LanguageName languageName, LanguageNameRequest request) {

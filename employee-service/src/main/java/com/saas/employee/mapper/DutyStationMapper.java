...
public class DutyStationMapper {
    ...
    public DutyStation mapToEntity(TenantDto tenant, DutyStationRequest request) {
    ...
    public DutyStation updateEntity(DutyStation dutyStation, DutyStationRequest request) {

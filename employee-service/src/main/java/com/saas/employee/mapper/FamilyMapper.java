...
public class FamilyMapper {
    ...
    public Family mapToEntity(TenantDto tenant, Employee employee, FamilyRequest request) {

        Family family = new Family();
        family.setTenantId(tenant.getId());
        family.setEmployee(employee);
        family.setRelationshipType(
                RelationshipType.valueOf(request.getRelationshipType().toUpperCase()));

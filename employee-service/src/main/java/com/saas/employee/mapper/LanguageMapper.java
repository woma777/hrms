...
public class LanguageMapper {
    ...
    public Language mapToEntity(TenantDto tenant, Employee employee, LanguageRequest request) {

        LanguageName languageName = validationUtil.getLanguageNameById(tenant.getId(), request.getLanguageNameId());

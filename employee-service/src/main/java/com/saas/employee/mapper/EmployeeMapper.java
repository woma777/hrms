...
public class EmployeeMapper {
    ...
    public Employee mapToEntity(TenantDto tenant, EmployeeRequest request, MultipartFile file) throws IOException {
        ...
        PayGradeDto payGrade = validationUtil.getPayGradeById(tenant.getId(), job.getId(), request.getPayGradeId());
        TitleName titleName = validationUtil.getTitleNameById(tenant.getId(), request.getTitleNameId());
        DutyStation dutyStation = validationUtil.getDutyStationById(tenant.getId(), request.getDutyStationId());
    ...
    public Employee updateEmployee(TenantDto tenant, Employee employee, EmployeeRequest request, MultipartFile file)
            throws IOException {

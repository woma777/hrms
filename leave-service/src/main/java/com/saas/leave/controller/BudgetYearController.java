...
@RestController
@RequestMapping("/api/leave/budget-years/{tenantId}")
...
public class BudgetYearController {
    ...
    @PostMapping("/add")
    public ResponseEntity<BudgetYearResponse> createBudgetYear(
            @PathVariable("tenantId") UUID tenantId, @RequestBody @Valid BudgetYearRequest budgetYearRequest) {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<BudgetYearResponse> getBudgetYearById(
    ...
    public ResponseEntity<BudgetYearResponse> updateBudgetYear(

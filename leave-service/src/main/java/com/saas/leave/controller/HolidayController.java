...
@RestController
@RequestMapping("/api/leave/holidays/{tenantId}")
...
public class HolidayController {
    ...
    public ResponseEntity<HolidayResponse> createHoliday(
            @PathVariable("tenantId") UUID tenantId, @RequestBody @Valid HolidayRequest holidayRequest) {
    ...
    public ResponseEntity<String> deleteHoliday(@PathVariable("tenantId") UUID tenantId, @PathVariable UUID id) {

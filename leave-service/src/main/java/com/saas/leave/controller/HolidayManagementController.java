...
@RestController
@RequestMapping("/api/leave/holiday-managements/{tenantId}")
...
public class HolidayManagementController {
    ...
    @PostMapping("/add")
    public ResponseEntity<HolidayManagementResponse> createHolidayManagement(
        ...
        HolidayManagementResponse createdHolidayManagement =
                holidayManagementService.createHolidayManagement(tenantId, holidayManagementRequest);
        return ResponseEntity.ok(createdHolidayManagement);
    }

    @GetMapping("/get-all")
    public ResponseEntity<List<HolidayManagementResponse>> getAllHolidayManagements(
            @PathVariable("tenantId") UUID tenantId) {

        permissionEvaluator.getAllHolidayManagementsPermission(tenantId);

        List<HolidayManagementResponse> holidayManagements =
                holidayManagementService.getAllHolidayManagements(tenantId);
        return ResponseEntity.ok(holidayManagements);
    }

    @GetMapping("/get/{id}")
    public ResponseEntity<HolidayManagementResponse> getHolidayManagementById(
    ...
    public ResponseEntity<HolidayManagementResponse> updateHolidayManagement(
            @PathVariable("tenantId") UUID tenantId,
        ...
        HolidayManagementResponse updatedHolidayManagement =
                holidayManagementService.updateHolidayManagement(tenantId, id, holidayManagementRequest);
        return ResponseEntity.ok(updatedHolidayManagement);
    }

    @DeleteMapping("/delete/{id}")
    public ResponseEntity<String> deleteHolidayManagement(
            @PathVariable("tenantId") UUID tenantId, @PathVariable UUID id) {

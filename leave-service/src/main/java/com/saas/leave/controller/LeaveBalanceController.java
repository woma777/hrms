...
@RestController
@RequestMapping("/api/leave/leave-balance/{tenantId}")
@AllArgsConstructor
...
public class LeaveBalanceController {
    ...
    public ResponseEntity<List<LeaveBalanceHistory>> getAllLeaveBalancesForEmployee(
            @PathVariable UUID employeeId, @PathVariable UUID tenantId) {

        permissionEvaluator.getEmployeeLeaveBalancePermission(tenantId);

        List<LeaveBalanceHistory> leaveBalances =
                leaveBalanceService.getAllLeaveBalancesForEmployee(employeeId, tenantId);
    ...
    public ResponseEntity<LeaveBalanceResponse> getLeaveBalanceForEmployee(
        ...
        LeaveBalanceResponse leaveBalanceResponse =
                leaveBalanceService.calculateLeaveBalanceForEmployee(tenantId, employeeId, budgetYearId);

...
@RestController
@RequestMapping("/api/leave/leave-settings/{tenantId}")
...
public class LeaveSettingController {
    ...
    public ResponseEntity<LeaveSettingResponse> createLeaveSetting(
            @PathVariable("tenantId") UUID tenantId, @RequestBody LeaveSettingRequest leaveSettingRequest) {
    ...
    public ResponseEntity<String> deleteLeaveSetting(@PathVariable("tenantId") UUID tenantId, @PathVariable UUID id) {

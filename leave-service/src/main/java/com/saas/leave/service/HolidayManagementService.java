...
public class HolidayManagementService {
    ...
    public HolidayManagementResponse createHolidayManagement(
            UUID tenantId, HolidayManagementRequest holidayManagementRequest) {
        ...
        if (holidayManagementRepository.existsByHolidayId(holidayManagementRequest.getHolidayId())) {
            throw new ResourceExistsException(
                    "Holiday with Name " + holidayManagementRequest.getHolidayId() + " already exists");
        }
    ...
    public HolidayManagementResponse getHolidayManagementById(UUID tenantId, UUID id) {
        ...
        HolidayManagement holidayManagement = holidayManagementRepository
                .findById(id)
    ...
    public HolidayManagementResponse updateHolidayManagement(
            UUID tenantId, UUID id, HolidayManagementRequest holidayManagementRequest) {
        // Validate the tenant ID
        if (tenantId == null) {
            throw new IllegalArgumentException("Tenant ID cannot be null");
        }

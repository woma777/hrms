...
public class PreServiceCourseTypeMapper {
    ...
    public PreServiceCourseType mapToEntity(TenantDto tenant, PreServiceCourseTypeRequest request) {
    ...
    public PreServiceCourseType updateEntity(
            PreServiceCourseType preServiceCourseType, PreServiceCourseTypeRequest request) {

...
public class TrainingCourseMapper {
    ...
    public TrainingCourse mapToEntity(TenantDto tenant, TrainingCourseRequest request) {
    ...
    public TrainingCourse updateEntity(TenantDto tenant, TrainingCourse trainingCourse, TrainingCourseRequest request) {

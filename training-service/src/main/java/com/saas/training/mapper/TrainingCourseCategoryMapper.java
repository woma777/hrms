...
public class TrainingCourseCategoryMapper {
    ...
    public TrainingCourseCategory mapToEntity(TenantDto tenant, TrainingCourseCategoryRequest request) {
    ...
    public TrainingCourseCategory updateEntity(
            TrainingCourseCategory trainingCourseCategory, TrainingCourseCategoryRequest request) {

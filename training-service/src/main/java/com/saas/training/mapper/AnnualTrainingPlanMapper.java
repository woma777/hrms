...
public class AnnualTrainingPlanMapper {
    ...
    public AnnualTrainingPlan mapToEntity(TenantDto tenant, AnnualTrainingPlanRequest request) {
    ...
    public AnnualTrainingPlanResponse mapToDto(AnnualTrainingPlan annualTrainingPlan) {
        ...
        response.setCourseCategoryId(
                annualTrainingPlan.getTrainingCourseCategory().getId());
        response.setTrainingCourseId(annualTrainingPlan.getTrainingCourse().getId());
        response.setTrainingInstitutionId(
                annualTrainingPlan.getTrainingInstitution().getId());
    ...
    public AnnualTrainingPlan updateEntity(
            TenantDto tenant, AnnualTrainingPlan annualTrainingPlan, AnnualTrainingPlanRequest request) {

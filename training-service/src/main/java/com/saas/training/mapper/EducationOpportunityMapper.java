...
public class EducationOpportunityMapper {
    ...
    public EducationOpportunity mapToEntity(
            TenantDto tenant, EmployeeDto employee, EducationOpportunityRequest request) {

        QualificationDto qualification =
                validationUtil.getQualificationById(tenant.getId(), request.getQualificationId());
    ...
    public EducationOpportunity updateEntity(
            TenantDto tenant,

...
public class PreServiceCourseMapper {
    ...
    public PreServiceCourse mapToEntity(TenantDto tenant, PreServiceCourseRequest request) {

        PreServiceCourseType preServiceCourseType =
                validationUtil.getCourseTypeById(tenant.getId(), request.getCourseTypeId());
    ...
    public PreServiceCourse updateEntity(
            TenantDto tenant, PreServiceCourse preServiceCourse, PreServiceCourseRequest request) {

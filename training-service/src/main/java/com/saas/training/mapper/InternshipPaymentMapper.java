...
public class InternshipPaymentMapper {
    ...
    public InternshipPayment mapToEntity(
            TenantDto tenant, InternshipStudent internshipStudent, InternshipPaymentRequest request) {
    ...
    public InternshipPayment updateEntity(InternshipPayment internshipPayment, InternshipPaymentRequest request) {

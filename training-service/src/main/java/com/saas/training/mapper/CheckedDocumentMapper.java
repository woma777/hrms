...
public class CheckedDocumentMapper {
    ...
    public CheckedDocument mapToEntity(TenantDto tenant, CheckedDocumentRequest request) {
    ...
    public CheckedDocument updateEntity(CheckedDocument checkedDocument, CheckedDocumentRequest request) {

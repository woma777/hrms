...
public class TrainingMapper {
    ...
    public Training mapToEntity(TenantDto tenant, TrainingRequest request) {
        ...
        TrainingInstitution trainingInstitution =
                validationUtil.getInstitutionById(tenant.getId(), request.getTrainingInstitutionId());
        TrainingCourseCategory trainingCourseCategory =
                validationUtil.getCategoryById(tenant.getId(), request.getCourseCategoryId());
        TrainingCourse trainingCourse =
                validationUtil.getTrainingCourseById(tenant.getId(), request.getTrainingCourseId());
    ...
    public Training updateEntity(TenantDto tenant, Training training, TrainingRequest request) {
        ...
        if (request.getTrainingType() != null) {
            training.setTrainingType(
                    TrainingType.valueOf(request.getTrainingType().toUpperCase()));
        }
    ...
    public Training approveTraining(Training training, TrainingApproveRequest request) {

        if (request.getDecision() != null) {
            training.setTrainingStatus(
                    TrainingStatus.valueOf(request.getDecision().toUpperCase()));
        }
        if (request.getRemark() != null) {
            training.setRemark(request.getRemark());
        }

...
public class TrainingInstitutionMapper {
    ...
    public TrainingInstitution mapToEntity(TenantDto tenant, TrainingInstitutionRequest request) {
    ...
    public TrainingInstitution updateEntity(
            TenantDto tenant, TrainingInstitution trainingInstitution, TrainingInstitutionRequest request) {

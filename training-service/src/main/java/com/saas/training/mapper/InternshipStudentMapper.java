...
public class InternshipStudentMapper {
    ...
    public InternshipStudent mapToEntity(TenantDto tenant, InternshipStudentRequest request) {
    ...
    public InternshipStudent updateEntity(
            TenantDto tenant, InternshipStudent internshipStudent, InternshipStudentRequest request) {

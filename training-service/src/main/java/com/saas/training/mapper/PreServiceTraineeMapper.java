...
public class PreServiceTraineeMapper {
    ...
    public PreServiceTrainee mapToEntity(TenantDto tenant, PreServiceTraineeRequest request, MultipartFile file)
            throws IOException {
        ...
        EducationLevelDto educationLevel =
                validationUtil.getEducationLevelById(tenant.getId(), request.getEducationLevelId());
        FieldOfStudyDto fieldOfStudy = validationUtil.getFieldOfStudyById(tenant.getId(), request.getFieldOfStudyId());
    ...
    public PreServiceTraineeResponse mapToDto(PreServiceTrainee preServiceTrainee) {
        ...
        if (preServiceTrainee.getCheckedDocuments() != null) {
            List<CheckedDocumentResponse> checkedDocuments = preServiceTrainee.getCheckedDocuments().stream()
    ...
    public PreServiceTrainee updateEntity(
            TenantDto tenant, PreServiceTrainee preServiceTrainee, PreServiceTraineeRequest request, MultipartFile file)
            throws IOException {

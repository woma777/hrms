...
public class UniversityMapper {
    ...
    public University mapToEntity(TenantDto tenant, UniversityRequest request) {
    ...
    public University updateEntity(TenantDto tenant, University university, UniversityRequest request) {

...
public class PreServiceTraineeResultMapper {
    ...
    public PreServiceTraineeResult mapToEntity(
            TenantDto tenant,
    ...
    public PreServiceTraineeResult updateEntity(
            PreServiceTraineeResult traineeResult, PreServiceTraineeResultRequest request) {

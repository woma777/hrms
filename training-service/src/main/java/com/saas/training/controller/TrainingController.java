...
public class TrainingController {
    ...
    public ResponseEntity<?> addTraining(
        ...
        TrainingResponse response = trainingService.addTraining(tenantId, request);
    ...
    public ResponseEntity<?> getAllTrainings(
        ...
        List<TrainingResponse> responses = trainingService.getAllTrainings(tenantId);
    ...
    public ResponseEntity<?> getTrainingById(
        ...
        TrainingResponse response = trainingService.getTrainingById(tenantId, trainingId);

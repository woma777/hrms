...
public class UniversityController {
    ...
    public ResponseEntity<?> addUniversity(
        ...
        UniversityResponse response = universityService.addUniversity(tenantId, request);
    ...
    public ResponseEntity<?> getAllUniversities(
        ...
        List<UniversityResponse> responses = universityService.getAllUniversities(tenantId);

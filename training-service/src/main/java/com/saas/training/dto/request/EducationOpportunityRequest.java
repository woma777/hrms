...
public class EducationOpportunityRequest {
    ...
    @NotNull(message = "Training location cannot be null") private String trainingLocation;

    @NotNull(message = "Country ID cannot be null") private UUID countryId;

    @NotNull(message = "Education level ID cannot be null") private UUID educationLevelId;

    @NotNull(message = "Qualification ID cannot be null") private UUID qualificationId;
    ...
    @NotNull(message = "End date cannot be null") @FutureOrPresent(message = "End date must be a present or future date")
    private LocalDate endDate;

    @NotNull(message = "Letter date cannot be null") @PastOrPresent(message = "Letter date must be a past or present date")
    ...
    @NotNull(message = "Employee ID cannot be null") private String employeeId;

    @NotNull(message = "Total result cannot be null") private Double totalResult;

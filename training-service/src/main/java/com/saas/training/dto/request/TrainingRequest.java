...
public class TrainingRequest {
    ...
    @NotNull(message = "Training type cannot be null") private String trainingType;
    ...
    @NotNull(message = "Number of participants cannot be null") @Min(value = 1, message = "Number of participants must be at least 1")
    private Integer numberOfParticipants;

    @NotNull(message = "Number of days cannot be null") @Min(value = 1, message = "Number of days must be at least 1")

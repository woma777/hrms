...
public class InternshipPaymentRequest {
    ...
    @NotNull(message = "Start date cannot be null") private LocalDate startDate;

    @NotNull(message = "End date cannot be null") private LocalDate endDate;

    @NotNull(message = "Payment amount cannot be null") @DecimalMin(value = "0.0", message = "Payment amount must be at least 0.0")
    private Double paymentAmount;

    @Size(max = 100, message = "Remark must be less than 100 characters")
    private String remark;

    @NotNull(message = "Internship student ID cannot be null") private UUID internId;

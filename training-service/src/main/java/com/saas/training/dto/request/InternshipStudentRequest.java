...
public class InternshipStudentRequest {
    ...
    @NotNull(message = "Phone number cannot be null") @Pattern(regexp = "\\+?[0-9. ()-]{7,25}", message = "Phone number must be a valid phone number")
    ...
    @NotNull(message = "University ID cannot be null") private UUID universityId;

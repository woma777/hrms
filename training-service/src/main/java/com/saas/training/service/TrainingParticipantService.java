...
public class TrainingParticipantService {
    ...
    public TrainingParticipantResponse addTrainingParticipant(UUID tenantId,
        ...
        TrainingParticipant trainingParticipant =
                trainingParticipantMapper.mapToEntity(tenant, training, employee, request);
    ...
    public TrainingParticipantResponse updateTrainingParticipant(UUID tenantId,
        ...
        if (request.getSearchBy().equalsIgnoreCase("NAME")) {
            employee = validationUtil.getEmployeeByName(
                    tenant.getId(), request.getFirstName(), request.getMiddleName(), request.getLastName());
        } else {
            employee = validationUtil.getEmployeeByEmployeeId(tenant.getId(), request.getParticipantEmployeeId());
        }
        TrainingParticipant trainingParticipant = getParticipantById(tenant.getId(), participantId);
    ...
    private TrainingParticipant getParticipantById(UUID tenantId,
                                                   UUID participantId) {

...
public class InternshipPaymentService {
    ...
    public InternshipPaymentResponse createInternshipPayment(UUID tenantId,
        ...
        if (internshipPaymentRepository
                .existsByTenantIdAndInternshipStudentId(tenant.getId(), request.getInternId())) {
            throw new ResourceExistsException(
                    "Internship student with id '" + request.getInternId() + "' already paid");
        }
        if (internshipStudent.getPlacedDepartmentId() == null) {
            throw new IllegalStateException("Cannot add payment for non-placed internship student.");
        }
    ...
    public InternshipPayment getPaymentById(UUID tenantId,
                                            UUID paymentId) {

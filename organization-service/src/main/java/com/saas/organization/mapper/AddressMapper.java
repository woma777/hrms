...
public class AddressMapper {
    ...
    public Address updateAddress(Address address, AddressRequest addressRequest) {
        ...
        if (addressRequest.getBlockNo() != null) address.setBlockNo(addressRequest.getBlockNo());
        if (addressRequest.getFloor() != null) address.setFloor(addressRequest.getFloor());
        if (addressRequest.getOfficeNumber() != null) address.setOfficeNumber(addressRequest.getOfficeNumber());
        if (addressRequest.getOfficeTelephone() != null)
            address.setOfficeTelephone(addressRequest.getOfficeTelephone());
        if (addressRequest.getMobileNumber() != null) address.setMobileNumber(addressRequest.getMobileNumber());
        if (addressRequest.getEmail() != null) address.setEmail(addressRequest.getEmail());
        if (addressRequest.getWebsite() != null) address.setWebsite(addressRequest.getWebsite());
        if (addressRequest.getPoBox() != null) address.setPoBox(addressRequest.getPoBox());

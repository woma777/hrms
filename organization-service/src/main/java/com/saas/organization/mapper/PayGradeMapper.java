...
public class PayGradeMapper {
    ...
    public PayGrade mapToEntity(PayGradeRequest payGradeRequest) {
        ...
        JobGrade jobGrade = jobGradeRepository
                .findById(payGradeRequest.getJobGradeId())
                .orElseThrow(() -> new RuntimeException("JobGrade not found"));
    ...
    public PayGrade updatePayGrade(PayGrade payGrade, PayGradeRequest payGradeRequest) {
        ...
        if (payGradeRequest.getInitialSalary() != null) payGrade.setInitialSalary(payGradeRequest.getInitialSalary());
        if (payGradeRequest.getMaximumSalary() != null) payGrade.setMaximumSalary(payGradeRequest.getMaximumSalary());
        if (payGradeRequest.getSalaryStep() != null) payGrade.setSalaryStep(payGradeRequest.getSalaryStep());
        if (payGradeRequest.getSalary() != null) payGrade.setSalary(payGradeRequest.getSalary());
        if (payGradeRequest.getDescription() != null) payGrade.setDescription(payGradeRequest.getDescription());

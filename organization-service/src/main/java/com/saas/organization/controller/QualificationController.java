...
public class QualificationController {
    ...
    public ResponseEntity<?> createQualification(
            @PathVariable("tenantId") UUID tenantId, @RequestBody QualificationRequest qualificationRequest) {
    ...
    @GetMapping("/get-all")
    public ResponseEntity<?> getAllQualifications(@PathVariable("tenantId") UUID tenantId) {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<?> getQualificationById(@PathVariable UUID id, @PathVariable("tenantId") UUID tenantId) {
    ...
    public ResponseEntity<?> updateQualification(
        ...
        QualificationResponse qualification =
                qualificationService.updateQualification(id, tenantId, qualificationRequest);
        return ResponseEntity.ok(qualification);
    }

    @DeleteMapping("/delete/{id}")
    public ResponseEntity<?> deleteQualification(@PathVariable UUID id, @PathVariable("tenantId") UUID tenantId) {

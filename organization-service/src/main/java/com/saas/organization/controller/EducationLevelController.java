...
public class EducationLevelController {
    ...
    public ResponseEntity<?> createEducationLevel(
            @PathVariable("tenantId") UUID tenantId, @RequestBody EducationLevelRequest educationLevelRequest) {

        permissionEvaluator.addEducationLevelPermission(tenantId);

        EducationLevelResponse educationLevel =
                educationLevelService.createEducationLevel(tenantId, educationLevelRequest);
        return new ResponseEntity<>(educationLevel, HttpStatus.CREATED);
    }

    @GetMapping("/get-all")
    public ResponseEntity<?> getAllEducationLevels(@PathVariable("tenantId") UUID tenantId) {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<?> getEducationLevelById(@PathVariable UUID id, @PathVariable("tenantId") UUID tenantId) {
    ...
    public ResponseEntity<?> updateEducationLevel(
        ...
        EducationLevelResponse educationLevel =
                educationLevelService.updateEducationLevel(id, tenantId, educationLevelRequest);
        return ResponseEntity.ok(educationLevel);
    }

    @DeleteMapping("/delete/{id}")
    public ResponseEntity<?> deleteEducationLevel(@PathVariable UUID id, @PathVariable("tenantId") UUID tenantId) {

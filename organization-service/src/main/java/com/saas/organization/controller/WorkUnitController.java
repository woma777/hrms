...
public class WorkUnitController {
    ...
    public ResponseEntity<?> createWorkUnit(
            @PathVariable("tenantId") UUID tenantId, @RequestBody WorkUnitRequest workUnitRequest) {
    ...
    @GetMapping("/get-all")
    public ResponseEntity<?> getAllWorkUnits(@PathVariable("tenantId") UUID tenantId) {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<?> getWorkUnitById(@PathVariable UUID id, @PathVariable("tenantId") UUID tenantId) {
    ...
    public ResponseEntity<?> deleteWorkUnit(@PathVariable UUID id, @PathVariable("tenantId") UUID tenantId) {

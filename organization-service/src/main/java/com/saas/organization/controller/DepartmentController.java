...
public class DepartmentController {
    ...
    public ResponseEntity<?> createDepartment(
            @PathVariable UUID tenantId, @RequestBody DepartmentRequest departmentRequest) {
    ...
    public ResponseEntity<?> changeParentDepartment(
        ...
        DepartmentResponse departmentResponse =
                departmentService.transferChildDepartment(tenantId, childDepartmentId, newParentDepartmentId);
        return ResponseEntity.ok(departmentResponse);
    }
    ...
    public ResponseEntity<?> transferParentDepartment(
        ...
        DepartmentResponse departmentResponse =
                departmentService.transferParentDepartment(tenantId, parentDepartmentId, newParentDepartmentId);
        return ResponseEntity.ok(departmentResponse);
    }

    @GetMapping("/get-all")
    public ResponseEntity<?> getAllDepartments(@PathVariable UUID tenantId) {
    ...
    public ResponseEntity<?> updateDepartment(
            @PathVariable UUID tenantId, @PathVariable UUID id, @RequestBody DepartmentRequest departmentRequest) {
    ...
    public ResponseEntity<?> addSubDepartment(
        ...
        DepartmentResponse departmentResponse =
                departmentService.addSubDepartment(parentId, tenantId, subDepartmentRequest);
        return ResponseEntity.ok(departmentResponse);
    }

    @DeleteMapping("/{parentId}/sub-departments/{subId}")
    public ResponseEntity<String> removeSubDepartment(
            @PathVariable UUID tenantId, @PathVariable UUID parentId, @PathVariable UUID subId) {
    ...
    public ResponseEntity<?> getParentDepartments(@PathVariable UUID tenantId) {
    ...
    public ResponseEntity<?> getAllChildDepartments(@PathVariable UUID departmentId, @PathVariable UUID tenantId) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<?> deleteDepartment(@PathVariable UUID id, @PathVariable UUID tenantId) {

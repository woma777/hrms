...
public class JobCategoryController {
    ...
    public ResponseEntity<?> createJobCategory(
            @PathVariable("tenantId") UUID tenantId, @RequestBody JobCategoryRequest jobCategoryRequest) {
    ...
    @GetMapping("/get-all")
    public ResponseEntity<?> getAllJobCategories(@PathVariable("tenantId") UUID tenantId) {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<?> getJobCategoryById(@PathVariable UUID id, @PathVariable("tenantId") UUID tenantId) {
    ...
    public ResponseEntity<?> deleteJobCategory(@PathVariable UUID id, @PathVariable("tenantId") UUID tenantId) {

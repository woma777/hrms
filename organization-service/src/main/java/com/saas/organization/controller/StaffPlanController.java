...
public class StaffPlanController {
    ...
    public ResponseEntity<?> createStaffPlan(
            @PathVariable("tenant-id") UUID tenantId, @RequestBody StaffPlanRequest staffPlanRequest) {
    ...
    @GetMapping("/get-all")
    public ResponseEntity<?> getAllStaffPlans(@PathVariable("tenant-id") UUID tenantId) {
    ...
    public ResponseEntity<?> getStaffPlanById(
            @PathVariable("tenant-id") UUID tenantId, @PathVariable UUID staffPlanId) {
    ...
    public ResponseEntity<?> deleteStaffPlan(@PathVariable("tenant-id") UUID tenantId, @PathVariable UUID id) {

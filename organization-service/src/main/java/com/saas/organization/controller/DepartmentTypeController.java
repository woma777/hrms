...
public class DepartmentTypeController {
    ...
    public ResponseEntity<?> createDepartmentType(
            @PathVariable("tenant-id") UUID tenantId, @RequestBody DepartmentTypeRequest departmentTypeRequest) {

        permissionEvaluator.addDepartmentTypePermission(tenantId);

        DepartmentTypeResponse departmentType =
                departmentTypeService.createDepartmentType(tenantId, departmentTypeRequest);
        return new ResponseEntity<>(departmentType, HttpStatus.CREATED);
    }

    @GetMapping("/get-all")
    public ResponseEntity<?> getAllDepartmentTypes(@PathVariable("tenant-id") UUID tenantId) {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<?> getDepartmentTypeById(@PathVariable UUID id, @PathVariable("tenant-id") UUID tenantId) {
    ...
    public ResponseEntity<?> updateDepartmentType(
        ...
        DepartmentTypeResponse location =
                departmentTypeService.updateDepartmentType(id, tenantId, departmentTypeRequest);
        return ResponseEntity.ok(location);
    }

    @DeleteMapping("/delete-departmentType/{id}")
    public ResponseEntity<?> deleteDepartmentType(@PathVariable UUID id, @PathVariable("tenant-id") UUID tenantId) {

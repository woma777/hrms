...
public class LocationController {
    ...
    public ResponseEntity<?> createLocation(
            @PathVariable("tenant-id") UUID tenantId, @RequestBody LocationRequest locationRequest) {

        permissionEvaluator.addLocationPermission(tenantId);

        LocationResponse location = locationService.createLocation(tenantId, locationRequest);
        return new ResponseEntity<>(location, HttpStatus.CREATED);
    }

    @GetMapping("/get-all")
    public ResponseEntity<?> getAllLocations(@PathVariable("tenant-id") UUID tenantId) {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<?> getLocationById(@PathVariable UUID id, @PathVariable("tenant-id") UUID tenantId) {
    ...
    public ResponseEntity<?> updateLocation(
        ...
        LocationResponse location = locationService.updateLocation(id, tenantId, locationRequest);
        return ResponseEntity.ok(location);
    }

    @DeleteMapping("/delete-location/{id}")
    public ResponseEntity<String> deleteLocation(@PathVariable UUID id, @PathVariable("tenant-id") UUID tenantId) {
    ...
    public ResponseEntity<String> removeSubLocation(
            @PathVariable("tenant-id") UUID tenantId, @PathVariable UUID parentId, @PathVariable UUID subId) {
    ...
    public ResponseEntity<?> getAllParentLocations(@PathVariable("tenant-id") UUID tenantId) {
    ...
    public ResponseEntity<?> getAllChildLocations(
            @PathVariable("tenant-id") UUID tenantId, @PathVariable UUID locationId) {

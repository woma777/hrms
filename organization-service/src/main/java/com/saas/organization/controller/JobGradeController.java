...
public class JobGradeController {
    ...
    public ResponseEntity<?> createJobGrade(
            @PathVariable("tenantId") UUID tenantId, @RequestBody JobGradeRequestDto jobGradeRequestDto) {
    ...
    @GetMapping("/get-all")
    public ResponseEntity<?> getAllJobGrades(@PathVariable("tenantId") UUID tenantId) {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<?> getJobGradeById(@PathVariable UUID id, @PathVariable("tenantId") UUID tenantId) {
    ...
    public ResponseEntity<?> deleteJobGrade(@PathVariable UUID id, @PathVariable("tenantId") UUID tenantId) {

...
public class FieldOfStudyController {
    ...
    public ResponseEntity<?> createFieldOfStudy(
            @PathVariable("tenantId") UUID tenantId, @RequestBody FieldOfStudyRequest fieldOfStudyRequest) {
    ...
    @GetMapping("/get-all")
    public ResponseEntity<?> getAllFieldOfStudies(@PathVariable("tenantId") UUID tenantId) {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<?> getFieldOfStudyById(@PathVariable UUID id, @PathVariable("tenantId") UUID tenantId) {
    ...
    public ResponseEntity<?> deleteFieldOfStudy(@PathVariable UUID id, @PathVariable("tenantId") UUID tenantId) {

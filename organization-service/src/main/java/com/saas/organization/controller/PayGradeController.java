...
public class PayGradeController {
    ...
    public ResponseEntity<?> createPayGrade(
            @PathVariable("tenant-id") UUID tenantId, @RequestBody PayGradeRequest payGradeRequest) {
    ...
    @GetMapping("/get-all")
    public ResponseEntity<?> getAllPayGrades(@PathVariable("tenant-id") UUID tenantId) {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<?> getPayGradeById(@PathVariable UUID id, @PathVariable("tenant-id") UUID tenantId) {
    ...
    public ResponseEntity<?> getPayGradesByJobGradeId(
            @PathVariable UUID jobGradeId, @PathVariable("tenant-id") UUID tenantId) {

        permissionEvaluator.getPayGradesByJobGradeIdPermission(tenantId);

        List<PayGradeResponse> response = payGradeService.getPayGradesByJobGradeId(jobGradeId, tenantId);
    ...
    public ResponseEntity<?> deletePayGrade(@PathVariable UUID id, @PathVariable("tenant-id") UUID tenantId) {

...
public class AddressController {
    ...
    public ResponseEntity<?> createAddress(
            @PathVariable("tenant-id") UUID tenantId, @RequestBody AddressRequest addressRequest) {
    ...
    @GetMapping("/get-all")
    public ResponseEntity<?> getAllAddresses(@PathVariable("tenant-id") UUID tenantId) {
    ...
    public ResponseEntity<?> getAddressById(@PathVariable("tenant-id") UUID tenantId, @PathVariable UUID addressId) {
    ...
    public ResponseEntity<?> getAddressByDepartmentId(
            @PathVariable("tenant-id") UUID tenantId, @PathVariable("department-id") UUID departmentId) {
    ...
    public ResponseEntity<?> deleteAddress(@PathVariable("tenant-id") UUID tenantId, @PathVariable UUID id) {

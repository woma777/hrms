...
public class StaffPlanService {
    ...
    public StaffPlanResponse createStaffPlan(UUID tenantId, StaffPlanRequest staffPlanRequest) {
        ...
        Optional.ofNullable(staffPlanRequest.getJobRegistrationId())
                .ifPresent(jobRegistrationId -> jobRegistrationRepository
                        .findById(jobRegistrationId)
                        .orElseThrow(() -> new EntityNotFoundException(
                                "Job Registration not found with ID: " + jobRegistrationId)));

        Optional.ofNullable(staffPlanRequest.getDepartmentId()).ifPresent(departmentId -> departmentRepository
    ...
    public StaffPlanResponse getStaffPlanById(UUID tenantId, UUID staffPlanId) {

        Tenant tenant = tenantRepository
                .findById(tenantId)
                .orElseThrow(() -> new ResourceNotFoundException("Tenant not found with id: " + tenantId));

        StaffPlan staffPlan = staffPlanRepository
                .findById(staffPlanId)
        ...
        StaffPlan staffPlan = staffPlanRepository
                ...
                .orElseThrow(() -> {
                    ...
                    return new ResourceNotFoundException(
                            "Staff-plan not found with id: " + id + " for the specified tenant");
                });

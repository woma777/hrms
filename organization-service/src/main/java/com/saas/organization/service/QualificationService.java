...
public class QualificationService {
    ...
    public QualificationResponse createQualification(UUID tenantId, QualificationRequest qualificationRequest) {
        ...
        if (qualificationRepository.existsByQualificationAndTenantId(
            ...
            throw new ResourceExistsException(
                    "Qualification with Name " + qualificationRequest.getQualification() + " already exists");
        }
    ...
    public QualificationResponse updateQualification(
            UUID id, UUID tenantId, QualificationRequest qualificationRequest) {
        Tenant tenant = getTenantById(tenantId);
    ...
    private JobRegistration getJobRegistrationById(UUID jobRegistrationId) {
        return jobRegistrationRepository
                ...
                .orElseThrow(
                        () -> new ResourceNotFoundException("JobRegistration not found with id: " + jobRegistrationId));
    }
}

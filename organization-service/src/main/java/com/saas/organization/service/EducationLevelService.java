...
public class EducationLevelService {
    ...
    public EducationLevelResponse createEducationLevel(UUID tenantId, EducationLevelRequest educationLevelRequest) {
        ...
        if (educationLevelRepository.existsByEducationLevelNameAndTenantId(
            ...
            throw new ResourceExistsException(
                    "Education Level with Name " + educationLevelRequest.getEducationLevelName() + " already exists");
        }
    ...
    public List<EducationLevelResponse> getAllEducationLevels(UUID tenantId) {
        ...
        return educationLevels.stream().map(educationLevelMapper::mapToDto).collect(Collectors.toList());
    }
    ...
    @Transactional
    public EducationLevelResponse updateEducationLevel(
            UUID id, UUID tenantId, EducationLevelRequest educationLevelRequest) {
        Tenant tenant = tenantRepository
                .findById(tenantId)
                .orElseThrow(() -> new ResourceNotFoundException("Tenant not found with id: " + tenantId + " "));
        EducationLevel educationLevel = educationLevelRepository

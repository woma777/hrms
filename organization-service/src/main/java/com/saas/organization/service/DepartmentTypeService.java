...
public class DepartmentTypeService {
    ...
    public DepartmentTypeResponse createDepartmentType(UUID tenantId, DepartmentTypeRequest departmentTypeRequest) {
        ...
        if (departmentTypeRepository.existsByDepartmentTypeNameAndTenantId(
            ...
            throw new ResourceExistsException(
                    "Department type with Name " + departmentTypeRequest.getDepartmentTypeName() + " already exists");
        }
    ...
    public DepartmentTypeResponse updateDepartmentType(
            UUID id, UUID tenantId, DepartmentTypeRequest departmentTypeRequest) {
        Tenant tenant = tenantRepository
                .findById(tenantId)
                .orElseThrow(() -> new ResourceNotFoundException("Tenant not found with id: " + tenantId + " "));
        DepartmentType departmentType = departmentTypeRepository

...
public class FieldOfStudyService {
    ...
    public FieldOfStudyResponse createFieldOfStudy(UUID tenantId, FieldOfStudyRequest fieldOfStudyRequest) {
        ...
        if (fieldOfStudyRepository.existsByFieldOfStudyAndTenantId(
            ...
            throw new ResourceExistsException(
                    "Field Of Study with Name " + fieldOfStudyRequest.getFieldOfStudy() + " already exists");
        }
    ...
    public FieldOfStudyResponse updateFieldOfStudy(UUID id, UUID tenantId, FieldOfStudyRequest fieldOfStudyRequest) {
        Tenant tenant = getTenantById(tenantId);

...
public class LocationTypeService {
    ...
    public LocationTypeResponse createLocationType(UUID tenantId, @Valid LocationTypeRequest locationTypeRequest) {
        // Validate input data
        ...
        if (locationTypeRequest.getDescription() == null
                || locationTypeRequest.getDescription().isEmpty()) {
        ...
        if (locationTypeRepository.existsByLocationTypeNameAndTenantId(
            ...
            throw new ResourceExistsException("LocationType with Name " + locationTypeRequest.getLocationTypeName()
    ...
    public LocationTypeResponse getLocationTypeById(UUID id, UUID tenantId) {
        ...
        LocationType locationType = locationTypeRepository
                ...
                .orElseThrow(() -> new ResourceNotFoundException(
                        "LocationType not found with id: " + id + " for the specified tenant"));

        return locationTypeMapper.mapToDto(locationType);
    }

    public LocationTypeResponse updateLocationType(UUID id, UUID tenantId, LocationTypeRequest locationTypeRequest) {
        Tenant tenant = tenantRepository
                .findById(tenantId)
                .orElseThrow(() -> new ResourceNotFoundException("Tenant not found with id: " + tenantId));

...
public class CriteriaNameMapper {
    ...
    public CriteriaName mapToEntity(TenantDto tenant, CriteriaName parentCriteriaName, CriteriaNameRequest request) {
    ...
    public CriteriaNameResponse mapToDto(CriteriaName criteriaName) {
        ...
        if (criteriaName.getParentCriteriaName() != null) {
            response.setParentCriteriaNameId(
                    criteriaName.getParentCriteriaName().getId());
        } else {
    ...
    public CriteriaName updateEntity(CriteriaName criteriaName, CriteriaNameRequest request) {

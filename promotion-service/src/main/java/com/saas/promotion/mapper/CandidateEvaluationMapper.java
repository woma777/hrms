...
public class CandidateEvaluationMapper {
    ...
    public CandidateEvaluation mapToEntity(TenantDto tenant, Candidate candidate, CandidateEvaluationRequest request) {

        PromotionCriteria criteria = validationUtil.getPromotionCriteria(tenant.getId(), request.getCriteriaId());

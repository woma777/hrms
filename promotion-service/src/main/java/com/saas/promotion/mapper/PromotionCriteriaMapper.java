...
public class PromotionCriteriaMapper {
    ...
    public PromotionCriteria mapToEntity(
            TenantDto tenant, PromotionCriteria parentCriteria, PromotionCriteriaRequest request) {

        CriteriaName criteriaName = validationUtil.getCriteriaNameById(tenant.getId(), request.getCriteriaNameId());
    ...
    public PromotionCriteriaResponse mapToDto(PromotionCriteria promotionCriteria) {
        ...
        if (promotionCriteria.getParentPromotionCriteria() != null) {
            response.setParentCriteriaId(
                    promotionCriteria.getParentPromotionCriteria().getId());
        } else {
    ...
    public PromotionCriteria updateEntity(
            TenantDto tenant, PromotionCriteria promotionCriteria, PromotionCriteriaRequest request) {

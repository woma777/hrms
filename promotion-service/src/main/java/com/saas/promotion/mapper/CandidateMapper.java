...
public class CandidateMapper {
    ...
    public Candidate mapToEntity(TenantDto tenant, CandidateRequest request) {

        RecruitmentDto recruitment =
                validationUtil.getRecruitmentByVacancyNumber(tenant.getId(), request.getVacancyNumber());
        EmployeeDto employee = validationUtil.getEmployeeByEmployeeId(tenant.getId(), request.getEmployeeId());
    ...
    public Candidate updateEntity(TenantDto tenant, Candidate candidate, CandidateRequest request) {

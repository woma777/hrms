...
public class CriteriaNameController {
    ...
    public ResponseEntity<?> addCriteriaName(
        ...
        CriteriaNameResponse response = criteriaNameService.addCriteriaName(tenantId, request);
    ...
    @GetMapping("/get-all")
    public ResponseEntity<?> getAllCriteriaNames(@PathVariable UUID tenantId) {

        permissionEvaluator.getAllCriteriaNamesPermission(tenantId);

        List<CriteriaNameResponse> responses = criteriaNameService.getAllCriteriaNames(tenantId);

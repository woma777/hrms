...
public class PromotionCriteriaController {
    ...
    public ResponseEntity<?> addSubPromotionCriteria(
        ...
        PromotionCriteriaResponse response =
                promotionCriteriaService.addSubPromotionCriteria(tenantId, parentId, request);
        return ResponseEntity.status(HttpStatus.CREATED).body(response);
    }
    ...
    public ResponseEntity<?> getAllSubPromotionCriteria(
        ...
        List<PromotionCriteriaResponse> responses =
                promotionCriteriaService.getAllSubPromotionCriteria(tenantId, parentId);
        return ResponseEntity.status(HttpStatus.OK).body(responses);
    }
    ...
    public ResponseEntity<?> getPromotionCriteriaById(
        ...
        PromotionCriteriaResponse response =
                promotionCriteriaService.getPromotionCriteriaById(tenantId, promotionCriteriaId);
    ...
    public ResponseEntity<?> updatePromotionCriteria(
        ...
        PromotionCriteriaResponse response =
                promotionCriteriaService.updatePromotionCriteria(tenantId, promotionCriteriaId, request);
        return ResponseEntity.status(HttpStatus.OK).body(response);
    }

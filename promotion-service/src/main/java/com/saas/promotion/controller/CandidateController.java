...
public class CandidateController {
    ...
    public ResponseEntity<?> addCandidate(
        ...
        CandidateResponse response = candidateService.addCandidate(tenantId, request);
    ...
    public ResponseEntity<?> getAllCandidates(
        ...
        List<CandidateResponse> response = candidateService.getAllCandidates(tenantId);
    ...
    public ResponseEntity<?> getCandidateById(
        ...
        CandidateResponse response = candidateService.getCandidateById(tenantId, promotionId);
        return ResponseEntity.status(HttpStatus.OK).body(response);
    }

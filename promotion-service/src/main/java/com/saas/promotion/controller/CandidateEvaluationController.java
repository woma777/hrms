...
public class CandidateEvaluationController {
    ...
    public ResponseEntity<?> getAllCandidateEvaluations(
        ...
        List<CandidateEvaluationResponse> responses =
                evaluationService.getAllCandidateEvaluations(tenantId, candidateId);
    ...
    public ResponseEntity<?> getCandidateEvaluationById(
        ...
        CandidateEvaluationResponse response =
                evaluationService.getCandidateEvaluationById(tenantId, candidateId, evaluationId);
    ...
    public ResponseEntity<?> updateCandidateEvaluation(
        ...
        CandidateEvaluationResponse response =
                evaluationService.updateCandidateEvaluation(tenantId, candidateId, evaluationId, result);
        return ResponseEntity.status(HttpStatus.OK).body(response);
    }

...
public class PromoteCandidateService {
    ...
    public PromoteCandidateResponse addPromoteCandidate(UUID tenantId,
        ...
        employeeServiceClient.addEmployeeHistory(
                tenant.getId(), employee.getId(), recruitment.getVacancyNumber(), request.getPayGradeId());
    ...
    public List<PromoteCandidateResponse> getAllPromoteCandidates(UUID tenantId) {
        ...
        TenantDto tenant = validationUtil.getTenantById(tenantId);
        List<PromoteCandidate> promoteCandidates = promoteCandidateRepository.findByTenantId(tenant.getId());
        return promoteCandidates.stream().map(promoteCandidateMapper::mapToDto).toList();
    }
    ...
    private PromoteCandidate getPromoteCandidate(UUID tenantId,
                                                 UUID promoteId) {

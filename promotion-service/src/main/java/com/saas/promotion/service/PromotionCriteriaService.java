...
public class PromotionCriteriaService {
    ...
    public PromotionCriteriaResponse addPromotionCriteria(UUID tenantId,
        ...
        if (promotionCriteriaRepository
            ...
            throw new ResourceExistsException(
                    "Promotion criteria with criteria name '" +
    ...
    public PromotionCriteriaResponse addSubPromotionCriteria(UUID tenantId,
        ...
        if (promotionCriteriaRepository.existsByTenantIdAndParentPromotionCriteriaAndCriteriaName(
                tenant.getId(), parentCriteria, criteriaName)) {
            throw new ResourceExistsException(
                    "Sub promotion criteria with criteria name '"
                            + criteriaName.getName() + "' already exists");
        }
    ...
    public List<PromotionCriteriaResponse> getAllPromotionCriteria(UUID tenantId) {
        ...
        TenantDto tenant = validationUtil.getTenantById(tenantId);
        List<PromotionCriteria> criteriaList = promotionCriteriaRepository.findByTenantId(tenant.getId());
    ...
    private void validateTotalWeight(UUID tenantId,
                                     double newWeight,
                                     UUID criteriaId) {
    ...
    private void validateSubTotalWeight(UUID tenantId,
    ...
    private CriteriaName getCriteriaName(TenantDto tenant,
        ...
        List<CriteriaName> criteriaNames = criteriaNameRepository
                .findByTenantIdAndParentCriteriaName(tenant.getId(), parentCriteria.getCriteriaName());

...
public class CriteriaNameService {
    ...
    public CriteriaNameResponse addCriteriaName(UUID tenantId,
        ...
        if (criteriaNameRepository.existsByTenantIdAndName(tenant.getId(), request.getName())) {
    ...
    public CriteriaNameResponse addSubCriteriaName(UUID tenantId,
        ...
        CriteriaName criteriaName = criteriaNameMapper.mapToEntity(tenant, parentCriteriaName, request);
        criteriaName = criteriaNameRepository.save(criteriaName);
        return criteriaNameMapper.mapToDto(criteriaName);
    }
    ...
    public List<CriteriaNameResponse> getAllSubCriteriaNames(UUID tenantId,
        ...
        return criteriaNames.stream().map(criteriaNameMapper::mapToDto).toList();
    }
    ...
    public CriteriaNameResponse getCriteriaNameById(UUID tenantId,
        ...
        TenantDto tenant = validationUtil.getTenantById(tenantId);
        CriteriaName criteriaName = validationUtil.getCriteriaNameById(tenant.getId(), criteriaNameId);
        return criteriaNameMapper.mapToDto(criteriaName);
    }
    ...
    @Transactional
    public void deleteCriteriaName(UUID tenantId,
                                   UUID criteriaNameId) {

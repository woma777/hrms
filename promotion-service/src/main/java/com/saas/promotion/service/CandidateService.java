...
public class CandidateService {
    ...
    public List<CandidateResponse> getAllCandidates(UUID tenantId) {
        ...
        TenantDto tenant = validationUtil.getTenantById(tenantId);
        List<Candidate> candidates = candidateRepository.findByTenantId(tenant.getId());
        return candidates.stream().map(candidateMapper::mapToDto).toList();
    }
    ...
    public CandidateResponse getCandidateById(UUID tenantId,
        ...
        TenantDto tenant = validationUtil.getTenantById(tenantId);
        Candidate candidate = validationUtil.getCandidateById(tenant.getId(), promotionId);
        return candidateMapper.mapToDto(candidate);
    }

...
public class ValidationUtil {
    ...
    public Recruitment getRecruitmentById(UUID tenantId, UUID recruitmentId) {
        ...
        return recruitmentRepository
                ...
                .orElseThrow(
                        () -> new ResourceNotFoundException("Recruitment not found with id '" + recruitmentId + "'"));
    }
    ...
    public MediaType getMediaTypeById(UUID tenantId, UUID mediaTypeId) {
        ...
        return mediaTypeRepository
                ...
                .orElseThrow(() -> new ResourceNotFoundException("Media type not found with id '" + mediaTypeId + "'"));
    }

    public Recruitment getRecruitmentByVacancyNumber(UUID tenantId, String vacancyNumber) {

        return recruitmentRepository
                .findByVacancyNumber(vacancyNumber)

...
public class EducationMapper {
    ...
    public Education mapToEntity(TenantDto tenant, Applicant applicant, EducationRequest request, MultipartFile file)
            throws IOException {

        FieldOfStudyDto fieldOfStudy = validationUtil.getFieldOfStudyById(request.getFieldOfStudyId(), tenant.getId());
        EducationLevelDto educationLevel =
                validationUtil.getEducationLevelById(request.getEducationLevelId(), tenant.getId());
        ...
        education.setEducationType(
                EducationType.valueOf(request.getEducationType().toUpperCase()));
    ...
    public Education updateEducation(
            TenantDto tenant, Education education, EducationRequest request, MultipartFile file) throws IOException {

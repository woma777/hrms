...
public class ReferenceMapper {
    ...
    public Reference mapToEntity(TenantDto tenant, Applicant applicant, ReferenceRequest request) {
    ...
    public Reference updateReference(Reference reference, ReferenceRequest request) {

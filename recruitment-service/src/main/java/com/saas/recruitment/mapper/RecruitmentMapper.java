...
public class RecruitmentMapper {
    ...
    public Recruitment mapToEntity(TenantDto tenant, RecruitmentRequest request) {

        EmployeeDto requester =
                validationUtil.getEmployeeByEmployeeId(tenant.getId(), request.getRequesterEmployeeId());
        ...
        recruitment.setRecruitmentType(
                RecruitmentType.valueOf(request.getRecruitmentType().toUpperCase()));
        recruitment.setRecruitmentMode(
                RecruitmentMode.valueOf(request.getRecruitmentMode().toUpperCase()));
    ...
    public Recruitment updateRecruitment(TenantDto tenant, Recruitment recruitment, RecruitmentRequest request) {
    ...
    public Recruitment approveRecruitment(Recruitment recruitment, RecruitmentApproveRequest request) {
        ...
        if (request.getDecision() != null) {
            recruitment.setRecruitmentStatus(
                    RecruitmentStatus.valueOf(request.getDecision().toUpperCase()));
        }
        if (request.getRemark() != null) {
            recruitment.setRemark(request.getRemark());
        }

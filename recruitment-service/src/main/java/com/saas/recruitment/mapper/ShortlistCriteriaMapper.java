...
public class ShortlistCriteriaMapper {
    ...
    public ShortlistCriteria mapToEntity(TenantDto tenant, Recruitment recruitment, ShortlistCriteriaRequest request) {
        ...
        shortlistCriteria.setExperienceType(
                ExperienceType.valueOf(request.getExperienceType().toUpperCase()));
    ...
    public ShortlistCriteria updateShortlistCriteria(
            TenantDto tenant, ShortlistCriteria shortlistCriteria, ShortlistCriteriaRequest request) {

        EducationLevelDto educationLevel =
                validationUtil.getEducationLevelById(tenant.getId(), request.getEducationLevelId());
        Recruitment recruitment = validationUtil.getRecruitmentById(tenant.getId(), request.getRecruitmentId());

...
public class ApplicantMapper {
    ...
    public Applicant mapToEntity(TenantDto tenant, Recruitment recruitment, ApplicantRequest request) {
    ...
    public Applicant updateApplicant(TenantDto tenant, Applicant applicant, ApplicantRequest request) {

...
public class AssessmentWeightMapper {
    ...
    public AssessmentWeight mapToEntity(TenantDto tenant, Recruitment recruitment, AssessmentWeightRequest request) {
    ...
    public AssessmentWeight updateAssessmentWeight(
            TenantDto tenant, AssessmentWeight assessmentWeight, AssessmentWeightRequest request) {
    ...
    private Double calculateTotalScore(
            Double written, Double interview, Double CGPA, Double experience, Double practicalExam, Double other) {

...
public class LanguageMapper {
    ...
    public Language mapToEntity(TenantDto tenant, Applicant applicant, LanguageRequest request) {

        LanguageNameDto languageName = validationUtil.getLanguageNameById(tenant.getId(), request.getLanguageNameId());
    ...
    public Language updateLanguage(TenantDto tenant, Language language, LanguageRequest request) {

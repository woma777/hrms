...
public class AdvertisementMapper {
    ...
    public Advertisement mapToEntity(TenantDto tenant, Recruitment recruitment, AdvertisementRequest request) {
        ...
        advertisement.setAnnouncementType(
                AnnouncementType.valueOf(request.getAnnouncementType().toUpperCase()));
    ...
    public AdvertisementResponse mapToDto(Advertisement advertisement) {
        ...
        if (advertisement.getMediaTypes() != null) {
            List<MediaTypeResponse> mediaTypes = advertisement.getMediaTypes().stream()
    ...
    public Advertisement updateAdvertisement(
            TenantDto tenant, Advertisement advertisement, AdvertisementRequest request) {

...
public class ExperienceMapper {
    public Experience mapToEntity(TenantDto tenant, Applicant applicant, ExperienceRequest request, MultipartFile file)
            throws IOException {
    ...
    public Experience updateExperience(Experience experience, ExperienceRequest request, MultipartFile file)
            throws IOException {

...
public class TrainingMapper {
    ...
    public Training mapToEntity(TenantDto tenant, Applicant applicant, TrainingRequest request, MultipartFile file)
            throws IOException {
    ...
    public Training updateTraining(Training training, TrainingRequest request, MultipartFile file) throws IOException {

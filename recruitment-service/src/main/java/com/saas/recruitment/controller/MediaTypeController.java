...
public class MediaTypeController {
    ...
    public ResponseEntity<?> addMediaType(
        ...
        MediaTypeResponse response = mediaTypeService.addMediaType(tenantId, request);
    ...
    public ResponseEntity<?> getAllMediaTypes(
        ...
        List<MediaTypeResponse> responses = mediaTypeService.getAllMediaTypes(tenantId);
    ...
    public ResponseEntity<?> getMediaTypeById(
        ...
        MediaTypeResponse response = mediaTypeService.getMediaTypeById(tenantId, mediaTypeId);
    ...
    public ResponseEntity<?> getMediaTypeByAdvertisementId(
        ...
        List<MediaTypeResponse> responses =
                mediaTypeService.getAllMediaTypesByAdvertisementId(tenantId, advertisementId);
        return ResponseEntity.status(HttpStatus.OK).body(responses);
    }
    ...
    public ResponseEntity<?> deleteMediaType(
        ...
        return ResponseEntity.status(HttpStatus.OK).body("Media type deleted successfully!");
    }
}

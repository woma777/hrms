...
public class ApplicantController {
    ...
    public ResponseEntity<?> createApplicant(
        ...
        ApplicantResponse response = applicantService.createApplicant(tenantId, request);
    ...
    public ResponseEntity<?> getAllApplicants(
        ...
        List<ApplicantResponse> responses = applicantService.getAllApplicants(tenantId, recruitmentId);
    ...
    public ResponseEntity<?> getApplicantById(
        ...
        ApplicantResponse response = applicantService.getApplicantById(tenantId, applicantId);
    ...
    public ResponseEntity<?> updateApplicant(
        ...
        ApplicantResponse response = applicantService.updateApplicant(tenantId, applicantId, request);
        return ResponseEntity.ok(response);
    }

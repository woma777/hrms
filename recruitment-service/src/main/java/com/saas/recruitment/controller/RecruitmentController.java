...
public class RecruitmentController {
    ...
    public ResponseEntity<?> createRecruitment(
        ...
        RecruitmentResponse response = recruitmentService.createRecruitment(tenantId, request);
    ...
    public ResponseEntity<?> getAllRecruitments(
        ...
        List<RecruitmentResponse> responses = recruitmentService.getAllRecruitments(tenantId);
    ...
    public ResponseEntity<?> getRecruitmentById(
        ...
        RecruitmentResponse response = recruitmentService.getRecruitmentById(tenantId, recruitmentId);

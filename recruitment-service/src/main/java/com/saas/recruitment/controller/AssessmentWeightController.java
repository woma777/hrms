...
public class AssessmentWeightController {
    ...
    public ResponseEntity<?> getAssessmentWeightById(
        ...
        AssessmentWeightResponse response =
                assessmentWeightService.getAssessmentWeightById(tenantId, assessmentWeightId);
    ...
    public ResponseEntity<?> getAssessmentWeightByRecruitmentId(
        ...
        AssessmentWeightResponse response =
                assessmentWeightService.getAssessmentWeightByRecruitmentId(tenantId, recruitmentId);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<?> updateAssessmentWeight(
        ...
        AssessmentWeightResponse response =
                assessmentWeightService.updateAssessmentWeight(tenantId, assessmentWeightId, request);
        return ResponseEntity.ok(response);
    }

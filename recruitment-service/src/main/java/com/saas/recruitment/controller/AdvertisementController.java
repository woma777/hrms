...
public class AdvertisementController {
    ...
    public ResponseEntity<?> createAdvertisement(
        ...
        AdvertisementResponse response = advertisementService.createAdvertisement(tenantId, request);
    ...
    public ResponseEntity<?> getAllAdvertisements(
        ...
        List<AdvertisementResponse> responses = advertisementService.getAllAdvertisements(tenantId);
    ...
    public ResponseEntity<?> removeMediaTypeFromAdvertisement(
        ...
        return ResponseEntity.status(HttpStatus.OK).body("Media type removed successfully!");
    }

...
public class ExamResultController {
    ...
    public ResponseEntity<?> getAllExamResult(
        ...
        List<ExamResultResponse> responses = examResultService.getAllExamResult(tenantId, recruitmentId);
    ...
    public ResponseEntity<?> deleteExamResult(
        ...
        examResultService.deleteExamResult(tenantId, recruitmentId, applicantId, examResultId);

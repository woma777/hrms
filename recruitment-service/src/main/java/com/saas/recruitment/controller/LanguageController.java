...
public class LanguageController {
    ...
    public ResponseEntity<?> getAllLanguages(
        ...
        List<LanguageResponse> languages = languageService.getAllLanguages(tenantId, applicantId);
    ...
    public ResponseEntity<?> getLanguageById(
        ...
        LanguageResponse language = languageService.getLanguageById(tenantId, applicantId, languageId);

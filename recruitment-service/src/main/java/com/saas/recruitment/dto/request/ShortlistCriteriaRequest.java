...
public class ShortlistCriteriaRequest {
    ...
    @NotNull(message = "Experience type cannot be null") private String experienceType;

    @DecimalMin(value = "0.0", message = "CGPA must be at least 0.0")
    @DecimalMax(value = "100.0", message = "CGPA must be at most 100.0")
    private Double CGPA;

    @NotNull(message = "Minimum experience cannot be null") private Integer minimumExperience;

    @NotNull(message = "Minimum age cannot be null") private Integer minimumAge;

    @NotNull(message = "Maximum age cannot be null") private Integer maximumAge;

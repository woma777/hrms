...
public class ApplicantRequest {
    ...
    @NotNull(message = "Date of birth cannot be null") @Past(message = "Date of birth must be a past date")
    ...
    @NotNull(message = "Recruitment ID cannot be null") private UUID recruitmentId;
}

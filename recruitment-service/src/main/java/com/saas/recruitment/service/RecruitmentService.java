...
public class RecruitmentService {
    ...
    public RecruitmentResponse updateRecruitment(UUID tenantId,
        ...
        if (recruitment.getRecruitmentStatus().equals(RecruitmentStatus.APPROVED)) {
            throw new IllegalStateException("Recruitment has already been approved. " +
                    "Updating an approved recruitment is not possible.");
        }
        if (recruitment.getRecruitmentStatus().equals(RecruitmentStatus.REJECTED)) {
            throw new IllegalStateException("Recruitment has already been rejected." +
                    " Updating a rejected recruitment is not possible.");
        }

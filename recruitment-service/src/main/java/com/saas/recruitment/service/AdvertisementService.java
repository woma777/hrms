...
public class AdvertisementService {
    ...
    public AdvertisementResponse createAdvertisement(UUID tenantId,
        ...
        if (!recruitment.getRecruitmentStatus().equals(RecruitmentStatus.APPROVED)) {
            throw new IllegalStateException(
                    "Cannot create advertisement for non-approved recruitment.");
        }
        boolean advertisementExists =
                advertisementRepository.existsByTenantIdAndRecruitment(tenant.getId(), recruitment);
    ...
    private Advertisement getAdvertById(UUID tenantId,
                                        UUID advertisementId) {

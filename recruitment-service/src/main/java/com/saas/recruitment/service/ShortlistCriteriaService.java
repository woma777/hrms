...
public class ShortlistCriteriaService {
    ...
    public List<ShortlistCriteriaResponse> getAllShortlistCriteria(UUID tenantId,
        ...
        return shortlistCriteria.stream().map(shortlistCriteriaMapper::mapToDto).toList();
    }
    ...
    private ShortlistCriteria getShortlistById(UUID tenantId,
                                               UUID shortlistCriteriaId) {

        return shortlistCriteriaRepository.findById(shortlistCriteriaId)

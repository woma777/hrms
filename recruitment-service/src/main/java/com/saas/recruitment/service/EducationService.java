...
public class EducationService {
    ...
    public List<EducationResponse> getAllEducations(UUID tenantId,
        ...
        TenantDto tenant = validationUtil.getTenantById(tenantId);
        Applicant applicant = validationUtil.getApplicantById(tenant.getId(), applicantId);
        List<Education> educations = educationRepository.findByTenantIdAndApplicant(tenant.getId(), applicant);
        return educations.stream().map(educationMapper::mapToDto).toList();
    }

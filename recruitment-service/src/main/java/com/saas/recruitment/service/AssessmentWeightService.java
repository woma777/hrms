...
public class AssessmentWeightService {
    ...
    public AssessmentWeightResponse createAssessmentWeight(UUID tenantId,
        ...
        if (!recruitment.getRecruitmentStatus().equals(RecruitmentStatus.APPROVED)) {
            throw new IllegalStateException(
                    "Cannot create assessment weight for non-approved recruitment.");
        }
        ...
        if (assessmentWeightExists) {
            throw new ResourceExistsException(
                    "Assessment weight already exists for the given recruitment.");
        }
        AssessmentWeight assessmentWeight = assessmentWeightMapper
    ...
    private AssessmentWeight getAssessmentById(UUID tenantId,
                                               UUID assessmentWeightId) {

...
@RestController
@RequestMapping("/api/auth/resources/{tenantId}")
...
public class ResourceController {
    ...
    public ResponseEntity<?> addResource(
        ...
        List<ResourceResponse> responses = resourceService.addResource(tenantId);
    ...
    public ResponseEntity<?> updateResource(
        ...
        ResourceResponse response = resourceService.updateResource(tenantId, resourceId, request);
        return ResponseEntity.status(HttpStatus.OK).body(response);
    }

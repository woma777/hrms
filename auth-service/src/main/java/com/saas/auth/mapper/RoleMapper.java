...
public class RoleMapper {
    ...
    public RoleRepresentation mapToEntity(TenantDto tenant, RoleRequest request) {
    ...
    public RoleRepresentation updateEntity(
            TenantDto tenant, RoleRepresentation roleRepresentation, RoleRequest request) {

...
public class UserMapper {
    ...
    public UserRepresentation mapToEntity(TenantDto tenant, String employeeId) {

        EmployeeDto employee = employeeServiceClient.getEmployeeByEmployeeId(tenant.getId(), employeeId);
    ...
    public UserRepresentation updateEntity(UUID tenantId, UserRepresentation userRepresentation, String employeeId) {

...
public class ValidationUtil {
    ...
    public UserRepresentation getUserRepresentation(UUID tenantId, String userId) {
        ...
        try {
            ...
            String userTenantId =
                    userRepresentation.getAttributes().get("tenantId").getFirst();
    ...
    public RoleRepresentation getRoleRepresentation(TenantDto tenant, String roleName) {
        try {
            ...
            String roleTenantId =
                    roleRepresentation.getAttributes().get("tenantId").getFirst();

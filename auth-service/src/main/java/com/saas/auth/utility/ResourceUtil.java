...
public class ResourceUtil {
    ...
    public void assignRoleToRelatedResources(UUID tenantId, String resourceName, Set<String> roles) {
        ...
        Map<String, List<String>> resourceMap = Map.of(
                EmployeeServiceResourceName.ADD_EMPLOYEE.getValue(),
                        List.of(
                ...
                EmployeeServiceResourceName.UPDATE_EMPLOYEE.getValue(),
                        List.of(AuthServiceResourceName.UPDATE_USER.getValue()),
                RecruitmentServiceResourceName.ADD_RECRUITMENT.getValue(),
                        List.of(EmployeeServiceResourceName.GET_EMPLOYEE_BY_EMPLOYEE_ID.getValue()));
    ...
    private Resource getResourceByName(UUID tenantId, String resourceName) {
        return resourceRepository
                ...
                .orElseThrow(
                        () -> new ResourceNotFoundException("Resource not found with name '" + resourceName + "'"));
    }
